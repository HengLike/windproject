<div id="sidebar" class="sidebar d-flex flex-column">
    <div class="sidebar-header">
        <div class="px-2">
            <img src="public/images/logo.jpg" alt="" width="40" height="40">
        </div>
        <div>
    ...
    <ul class="list-unstyled mt-3 flex-grow-1">
        <?php if(isset($_SESSION['user']['role']) && $_SESSION['user']['role'] == 'admin') { ?>
            <li><a href="./" class="sidebar-link <?= ($GLOBALS['currentRoute']=='/'?'active':'') ?>">
                <i class="fas fa-wind"></i> <span data-i18n="dashboard"></span>
            </a></li>
            <li><a href="map" class="sidebar-link <?= ($GLOBALS['currentRoute']=='/map'?'active':'') ?>">
                <i class="fa-solid fa-map-location-dot"></i> <span data-i18n="map_setting"></span>
            </a></li>
            <li><a href="member" class="sidebar-link <?= ($GLOBALS['currentRoute']=='/member'?'active':'') ?>">
                <i class="fa-solid fa-users-line"></i> <span data-i18n="member"></span>
            </a></li>
            <li><a href="news" class="sidebar-link <?= ($GLOBALS['currentRoute']=='/news'?'active':'') ?>">
                <i class="fa-regular fa-newspaper"></i> <span data-i18n="news"></span>
            </a></li>
            <li><a href="document" class="sidebar-link <?= ($GLOBALS['currentRoute']=='/document'?'active':'') ?>">
                <i class="fa-solid fa-folder-tree"></i> <span data-i18n="document"></span>
            </a></li>
            <li><a href="import" class="sidebar-link <?= ($GLOBALS['currentRoute']=='/import'?'active':'') ?>">
                <i class="fa-solid fa-upload"></i> <span data-i18n="import"></span>
            </a></li>
            <li><a href="notification" class="sidebar-link <?= ($GLOBALS['currentRoute']=='/notification'?'active':'') ?>">
                <i class="bi bi-bell"></i> <span data-i18n="notification"></span>
            </a></li>
            <li><a href="setting" class="sidebar-link <?= ($GLOBALS['currentRoute']=='/setting'?'active':'') ?>">
                <i class="fa-solid fa-gear"></i> <span data-i18n="setting"></span>
            </a></li>
            <li><a href="shortcut" class="sidebar-link <?= ($GLOBALS['currentRoute']=='/shortcut'?'active':'') ?>">
                <i class="fa-regular fa-circle-down"></i> <span data-i18n="shortcut"></span>
            </a></li>
        <?php } else { ?>
            <li><a href="./" class="sidebar-link <?= ($GLOBALS['currentRoute']=='/' || $GLOBALS['currentRoute']=='/map' ?'active':'') ?>">
            ...
            <li><a href="download" class="sidebar-link <?= ($GLOBALS['currentRoute']=='/download'?'active':'') ?>">
